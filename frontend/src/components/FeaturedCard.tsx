...
export const FeaturedCard = ({date,readTime,title,content,author} : FeaturedCardProps) => {
  return (
    <Link to={'/blogs'}>
        ...
        <div className="p-6 h-full w-96 bg-white border border-gray-200 rounded-lg hover:shadow-lg transition-all transform hover:scale-105 hover:shadow-slate-400 hover:duration-300">
